...
BEGIN  
    ...
    (
        Name,Email,Contact,Address,Department,Designation,Role,Status,ProfilePhoto
    )
    VALUES
    (
        @Name,@Email,@Contact,@Address,@Department,@Designation,@Role,@Status,@ProfilePhoto
...
BEGIN
    INSERT INTO AddEmployees
    (
        Name,Email,Contact,Address,Department,Designation,Manager,Role,Status,ProfilePhoto
    )
    VALUES
    (
        @Name,@Email,@Contact,@Address,@Department,@Designation,@Manager,@Role,@Status,@ProfilePhoto
